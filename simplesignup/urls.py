...
from .views import RegisterView, EventListView, RequestLoginLinkView, EmailLoginConfirmView, EventAllView
...
urlpatterns = [
    ...
    path('events/all/', EventAllView.as_view(), name='event_list'),
